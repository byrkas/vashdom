...
class AuthManager
{
    ...
    public function logout()
    {
        ...
        if ($this->authService->getIdentity()==null) {
            $this->flashMessenger->addErrorMessage('The user is not logged in');
        }

        // Remove identity from session.
        $this->authService->clearIdentity();
        $this->flashMessenger->addSuccessMessage('Successfully logout');
    }
    ...
    public function filterAccess($controllerName, $actionName)
    {
        ...
        if ($mode!='restrictive' && $mode!='permissive')
            $this->flashMessenger->addErrorMessage('Invalid access filter mode (expected either restrictive or permissive mode');
